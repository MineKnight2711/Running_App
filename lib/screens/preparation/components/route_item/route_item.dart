...
class RouteItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding:
          isSelected ? EdgeInsets.symmetric(vertical: 5.h) : EdgeInsets.zero,
      margin: EdgeInsets.symmetric(vertical: 5.h),
      alignment: Alignment.center,
      decoration: BoxDecoration(
          color:
              isSelected ? AppColors.basicActivitiesCard : Colors.transparent,
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            ...
                            style: CustomGoogleFonts.roboto(
                                fontSize: 14.r, color: TextColor.secondaryText),
                          ),
                          SizedBox(
                            width: 60.w,
                          ),
                          ...
                          Text(
                            ...
                            style: CustomGoogleFonts.roboto(
                                fontSize: 16.r, color: TextColor.secondaryText),
                          ),
                        ],
                      ),
                      haveRunnerAttemps
